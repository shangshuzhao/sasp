...
for seed in "${SEEDS[@]}"; do
    ...
    python tune_v1.py --prefix "t1" --alpha $1 --seed $seed
    python encode_sasp_ukb.py --prefix "t1" --alpha $1 --seed $seed
    python encode_sasp_medex.py --prefix "t1" --alpha $1 --seed $seed
done
